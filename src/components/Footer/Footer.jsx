    ...
    return (
        <>
            <div className="footer__box footer__marcaDeAgua width100vw textoGrisOscuro" id="Contacto">
                ...
                <section className="footer_boxContent">
                    <h4 className="textoCentrado espaciadoRedesTop letterSpacing textUnderline">CONTÁCTANOS</h4>
                ...
                <section className="footer_boxContent">
                    <h4 className="textoCentrado espaciadoRedesTop letterSpacing textUnderline">HORARIOS</h4>
