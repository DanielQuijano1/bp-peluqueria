        ...
        <>
            ...
            <section className="main_section ">
                <div className="main_flexPhotos main_borders">
                    <div className="main__img img1 animacionScroll"></div>
                    <div className="textoImg animacionScroll"><Balancer className="widthYheigth100">Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium qui consequuntur quo nisi, natus recusandae autem molestias sunt unde. Quibusdam beatae officia sapiente vero quos! Numquam fugiat sit ullam unde?</Balancer></div>
                </div>
                <div className="main_flexPhotos">
                    <div className="textoImg animacionScroll"><Balancer className="widthYheigth100">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto, a eos quis consequuntur vel dolorem repellat minus nulla asperiores sequi saepe unde qui quae ab. Atque mollitia consequatur vero error.</Balancer></div>
                    <div className="main__img img2 animacionScroll"></div>
                </div>
            </section>
